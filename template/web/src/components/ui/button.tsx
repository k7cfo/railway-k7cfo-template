  ...
  ),
  {
    variants: {
      variant: {
        ...
        accent: cn("bg-[var(--accent)] text-white border-[var(--accent)]", "hover:opacity-90"),
      ...
      size: {
        default: "h-10 px-5 text-xs has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3",
